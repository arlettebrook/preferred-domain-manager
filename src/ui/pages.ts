...
#settings.page.active{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:20px}
...
@media(max-width:980px){#settings.page.active{display:grid;grid-template-columns:minmax(0,1fr);gap:16px;width:100%;max-width:100%;min-width:0}#settings.page.active>.page-head,#settings.page.active>.settings-card{grid-column:1/-1!important;width:100%;min-width:0}#settings.page.active>.settings-card{margin:0}#settings.page.active>.settings-card>.section-head{width:calc(100% - 54px)}}
