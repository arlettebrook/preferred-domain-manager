...
<div class="shell">
  <header class="site-header">
    ...
    <div class="header-actions">
      ...
      <a class="header-action" href="${safeAdminPath}" aria-label="进入管理控制台"><svg class="admin-icon" viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="4" width="18" height="14" rx="2"/><path d="M8 21h8M12 18v3M7 9l2 2-2 2M12 13h5"/></svg><span class="action-label">管理控制台</span><span class="admin-arrow" aria-hidden="true">↗</span></a>
    </div>
  </header>
