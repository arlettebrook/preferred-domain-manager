...
for (const [name, source, markers] of [
  ["config", config, ["const CRON_INTERVAL_MINUTES = 30", "durableObjectName: \"preferred-ip-cron\"", "storageKey: \"cronConfig\"", "routes:", "apiRoutes:"]],
